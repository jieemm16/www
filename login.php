        ...
        <div class="container1">
            <div class="row">
                <div class="col-md-4 my-2 ">
                    <h1 id="logo"><i class="fas fa-recycle"></i> EnviroCycle</h1>
                </div>
                    ...
                    <ul id="menu" class="float-md-end">
                        ...
                        <li><div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                              <li><a class="dropdown-item" href="/EnviroCycle/loginRegister/register.php">User Login</a></li>
                    ...
                    <div class="col-md-4 m-3">
                        ...
                        <form action="validation.php" method="post">
                            <div class="form-group">
                                ...
                                <input type="username" id="username" name="username" class="form-control" placeholder="Enter Username" pattern=".{4,}" title="Must 4 or more letters">
                            </div>
                            <div class="form-group">
                                <label>Password</label>
                                <input type="password" id="password" name="password" class="form-control" placeholder="Enter Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                            </div>
                            <br>
