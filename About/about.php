...
<body>
        ...
        <div class="container">
            ...
            <div class="col-md-6 forms">
                <form class="p-3" action="insert.php" method="post">
                    <h3 style="Font-size: 32px" class="text-center">Contact</h3>
                    <hr class="mb-5">
    ...
    <div id="footer" class="p-3">
        <div class="container">
            <div class="row">
                <div class="col-md-6" style="font-size: 15px;">@copyright EnviroCycle</div>
                <div class="col-md-6">
